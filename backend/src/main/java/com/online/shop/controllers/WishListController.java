...
public class WishListController {
	...
	public ResponseEntity<String> addToWishList(@PathVariable Long productId,Principal principal) {
		wishListService.addInWishList(productId,principal);
	...
	public ResponseEntity<String> isInWishlist(Principal principal,@PathVariable Long productId){
		if(wishListService.isInWishlist(principal,productId))
