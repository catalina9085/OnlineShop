...
public class SettingsController {
	...
	public ResponseEntity<String> addShipment(@RequestBody AddShipmentRequest request,Principal principal) {
		try {
			settingsService.addShipment(request,principal);
	...
	public ResponseEntity<String> setNotificationsPreferences(@RequestBody AddNotificationsRequest request,Principal principal){
		settingsService.setNotificationsPreferences(request,principal);
